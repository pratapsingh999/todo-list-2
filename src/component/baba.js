...
function Todoapp() {
  ...
  const [todo, settodo] = useState([Saveitems]);
  const [doing, setdoing] = useState([Saveitems]);
  ...
  return (
    <>
      ...
      <div class="col-auto add">
        ...
        <button type="submit2" class="btn btn-primary mb-3">
          <i className="fa fa-plus" title="Add Item" onClick={storedata}></i>
        </button>
      </div>
